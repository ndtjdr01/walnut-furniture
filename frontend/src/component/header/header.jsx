...
const Header = ({ setIsLogin, setFormDisplay }) => {
  const { token, cartItems } = useContext(ProductContext)
  const handleLogOut = () => {
    ...
    <div className='header'>
      ...
      <div className="navbar">
        <ul>
          ...
          <li><a onClick={(e) => { e.preventDefault(); setFormDisplay(true) }} href='' >Liên hệ</a></li>
      ...
      <div className="action">
        ...
        <div className='cart-img-container'>
          ...
          <div className="dot">{Object.keys(cartItems).length > 0 ? Object.keys(cartItems).length : null}</div>
        </div>
        {token
